...
// Tablica obiektów.
    ...
    public static void ShowAllWeaponParams(int id) {
        ...
        System.out.println("Attack Speed Improve = " + SwordsArray[id].improveAttackSpeed);
        System.out.println("Crit Rating improve =" + SwordsArray[id].improveCritRating);
        System.out.println("HP improve = " + SwordsArray[id].improveHP);
